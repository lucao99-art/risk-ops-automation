...
class GestorProdutividade:
    ...
    def __int__(self, db_name='operacao_risco.db'):
    ...
    def salvar_dados(self, analista, qtd_chats):
        ...
        cursor.execute ('''
            ...
            INSERT INTO produtividade (analista, chats_atendidos, data.

            VALUES (?, ?, ?)

        ''', (analista, qdt_chats, data_atual))
    ...
    def.to_csv('relatorio_n1.csv', index=False)
